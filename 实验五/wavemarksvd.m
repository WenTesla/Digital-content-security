...
% 输入格式举例 :
% [ watermarkimagergb, watermarkimage, waterCA, watermark, correlationU, correlationV]
% = wavemarksvd( 'c: \ lenna. jpg', 'c: \test. png', 1983, 'db6', 2, 0 . 1 , 0. 99 )
% 参数说明 :
% input 为输入原始图像
% seed 为随机数种子
% wavelet 为使用的小波函数
...
CA_tilda( over1) = 1;
CA_tilda( below0 ) = 0; % 系数调整 , 将过幅系数与负数 修正
